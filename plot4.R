plot4 <- function() {
  ...
  # create plot
  par(mfrow = c(2, 2))
  plot(pc1$DateTime, pc1$Global_active_power, type = "l", ylab="Global Active Power", xlab="")
  plot(pc1$DateTime, pc1$Voltage, type = "l", ylab="Voltage", xlab="datetime")
  ...
  plot(pc1$DateTime, pc1$Global_reactive_power, type = "l", ylab="Global_reactive_power", xlab="datetime")
